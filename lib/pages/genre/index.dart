...
class _GenreState extends State<GenrePage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            InkWell(
              onTap: () {
                Navigator.pushNamed(context, '/genre/create');
              },
                                          ...
                                          Center(
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                RaisedButton(
                                                  onPressed: (){
                                                    _deleteData(context, genre.hashid);
                                                  },
  ...
  Future _deleteData(BuildContext context, String hashid) async {
    Navigator.pop(context);
    final res = await GenreApi.delete(hashid);
